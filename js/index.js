function start(){ // Inicio da função
	...
	var jogo = {}
	var velocidade = 5;
	var posicaoY = parseInt(Math.random() * 324);
	var TECLA = {
	W: 87,
	S: 83,
	D: 68
	...
	function moveinimigo1() {
		...
		if (posicaoX <= 0){
		posicaoY = parseInt(Math.random() * 324);
	...
	function explosao1(inimigo1X, inimigo1Y) {
		...
		var tempoExplosao = window.setInterval(removeExplosao, 9000);
	...
	function explosao3(amigoX, camigoY) {
		somPerdido.play();
